...
class Screen {
  ...
  constructor(options) {
    ...
    if (Screen.Instance instanceof Screen) {
      throw new Error(
        "Singleton instance of PerformanceController already exists"
      );
    }
  ...
  initialize() {
    ...
    this.deviceDisplays = [];
    for (let i = 0; i < 8; i++) {
      this.deviceDisplays.push(
        this.createDeviceDisplay({
          name: deviceNames[i],
          left: (i % 8) * 12,
          top: 0
        })
    ...
    this.knobsDisplays = [];
    for (let i = 0; i < 16; i++) {
      this.knobsDisplays.push(
        this.createControllerDisplay({
          label: "",
          left: (i % 8) * 12,
          top: i < 8 ? 0 : 2
        })
    ...
    this.commandInput.on("keypress", (ch, key) => {
      ...
      if (fkeys.indexOf(key.name) >= 0) {
        ...
        this._state.commandHistoryIndex = Math.max(
          this._state.commandHistoryIndex - 1,
          0
        );
        ...
        this._state.commandHistoryIndex = Math.min(
          this._state.commandHistoryIndex + 1,
          this._state.commandHistory.length
        );
        let cmd = this._state.commandHistory[this._state.commandHistoryIndex];
        this.commandInput.setValue(cmd);
        this._screen.render();
    ...
    // Scene State
    ////////////////////////////////////////////////////////////////
    this.sceneConfigBox = blessed.box(
      Object.assign(
        {
          label: "Scene",
          //scrollable: true,
    ...
    // Track State
    ////////////////////////////////////////////////////////////////
    this.trackConfigBox = blessed.box(
      Object.assign(
        {
          label: "Track",
          //scrollable: true,
  ...
  updateTrackState(trackState) {
    ...
    let keys = ["instrument", "note", "velocity", "constants", "linearGraph"];
  ...
  updateClock(duration) {
    ...
    this._state.tickDurations = this._state.tickDurations.splice(
      Math.max(0, this._state.tickDurations.length - historyLength),
      historyLength
    );
    let tickMillis =
      this._state.tickDurations.reduce((sum, value) => sum + value) /
      this._state.tickDurations.length;
  ...
  controller(status, d1, d2) {
    switch (status) {
      case 144: // Note on
        switch (d1) {
          case BeatStepControllerMap.Pad1:
            this.updateControllerValue(this.padDisplays[8], d2);
            break;
          case BeatStepControllerMap.Pad2:
            this.updateControllerValue(this.padDisplays[9], d2);
            break;
          case BeatStepControllerMap.Pad3:
            this.updateControllerValue(this.padDisplays[10], d2);
            break;
          case BeatStepControllerMap.Pad4:
            this.updateControllerValue(this.padDisplays[11], d2);
            break;
          case BeatStepControllerMap.Pad5:
            this.updateControllerValue(this.padDisplays[12], d2);
            break;
          case BeatStepControllerMap.Pad6:
            this.updateControllerValue(this.padDisplays[13], d2);
            break;
          case BeatStepControllerMap.Pad7:
            this.updateControllerValue(this.padDisplays[14], d2);
            break;
          case BeatStepControllerMap.Pad8:
            this.updateControllerValue(this.padDisplays[15], d2);
            break;
          case BeatStepControllerMap.Pad9:
            this.updateControllerValue(this.padDisplays[0], d2);
            break;
          case BeatStepControllerMap.Pad10:
            this.updateControllerValue(this.padDisplays[1], d2);
            break;
          case BeatStepControllerMap.Pad11:
            this.updateControllerValue(this.padDisplays[2], d2);
            break;
          case BeatStepControllerMap.Pad12:
            this.updateControllerValue(this.padDisplays[3], d2);
            break;
          case BeatStepControllerMap.Pad13:
            this.updateControllerValue(this.padDisplays[4], d2);
            break;
          case BeatStepControllerMap.Pad14:
            this.updateControllerValue(this.padDisplays[5], d2);
            break;
          case BeatStepControllerMap.Pad15:
            this.updateControllerValue(this.padDisplays[6], d2);
            break;
          case BeatStepControllerMap.Pad16:
            this.updateControllerValue(this.padDisplays[7], d2);
            break;
        }
        break;
      case 128: // Note off
      ...
      case 176: // Control Change
        switch (d1) {
          case BeatStepControllerMap.Knob1:
            this.updateControllerValue(this.knobsDisplays[0], d2);
            break;
          case BeatStepControllerMap.Knob2:
            this.updateControllerValue(this.knobsDisplays[1], d2);
            break;
          case BeatStepControllerMap.Knob3:
            this.updateControllerValue(this.knobsDisplays[2], d2);
            break;
          case BeatStepControllerMap.Knob4:
            this.updateControllerValue(this.knobsDisplays[3], d2);
            break;
          case BeatStepControllerMap.Knob5:
            this.updateControllerValue(this.knobsDisplays[4], d2);
            break;
          case BeatStepControllerMap.Knob6:
            this.updateControllerValue(this.knobsDisplays[5], d2);
            break;
          case BeatStepControllerMap.Knob7:
            this.updateControllerValue(this.knobsDisplays[6], d2);
            break;
          case BeatStepControllerMap.Knob8:
            this.updateControllerValue(this.knobsDisplays[7], d2);
            break;
          case BeatStepControllerMap.Knob9:
            this.updateControllerValue(this.knobsDisplays[8], d2);
            break;
          case BeatStepControllerMap.Knob10:
            this.updateControllerValue(this.knobsDisplays[9], d2);
            break;
          case BeatStepControllerMap.Knob11:
            this.updateControllerValue(this.knobsDisplays[10], d2);
            break;
          case BeatStepControllerMap.Knob12:
            this.updateControllerValue(this.knobsDisplays[11], d2);
            break;
          case BeatStepControllerMap.Knob13:
            this.updateControllerValue(this.knobsDisplays[12], d2);
            break;
          case BeatStepControllerMap.Knob14:
            this.updateControllerValue(this.knobsDisplays[13], d2);
            break;
          case BeatStepControllerMap.Knob15:
            this.updateControllerValue(this.knobsDisplays[14], d2);
            break;
          case BeatStepControllerMap.Knob16:
            this.updateControllerValue(this.knobsDisplays[15], d2);
            break;
        }
        break;
    }
  ...
  setControllerMap(ctrlMap) {
    ...
    this.updateControllerLabel(
      this.knobsDisplays[0],
      this._controllerMap.controlChange.Knob1
    );
    this.updateControllerLabel(
      this.knobsDisplays[1],
      this._controllerMap.controlChange.Knob2
    );
    this.updateControllerLabel(
      this.knobsDisplays[2],
      this._controllerMap.controlChange.Knob3
    );
    this.updateControllerLabel(
      this.knobsDisplays[3],
      this._controllerMap.controlChange.Knob4
    );
    this.updateControllerLabel(
      this.knobsDisplays[4],
      this._controllerMap.controlChange.Knob5
    );
    this.updateControllerLabel(
      this.knobsDisplays[5],
      this._controllerMap.controlChange.Knob6
    );
    this.updateControllerLabel(
      this.knobsDisplays[6],
      this._controllerMap.controlChange.Knob7
    );
    this.updateControllerLabel(
      this.knobsDisplays[7],
      this._controllerMap.controlChange.Knob8
    );
    this.updateControllerLabel(
      this.knobsDisplays[8],
      this._controllerMap.controlChange.Knob9
    );
    this.updateControllerLabel(
      this.knobsDisplays[9],
      this._controllerMap.controlChange.Knob10
    );
    this.updateControllerLabel(
      this.knobsDisplays[10],
      this._controllerMap.controlChange.Knob11
    );
    this.updateControllerLabel(
      this.knobsDisplays[11],
      this._controllerMap.controlChange.Knob12
    );
    this.updateControllerLabel(
      this.knobsDisplays[12],
      this._controllerMap.controlChange.Knob13
    );
    this.updateControllerLabel(
      this.knobsDisplays[13],
      this._controllerMap.controlChange.Knob14
    );
    this.updateControllerLabel(
      this.knobsDisplays[14],
      this._controllerMap.controlChange.Knob15
    );
    this.updateControllerLabel(
      this.knobsDisplays[15],
      this._controllerMap.controlChange.Knob16
    );

    this.updateControllerLabel(
      this.padDisplays[8],
      this._controllerMap.noteOn.Pad1
    );
    this.updateControllerLabel(
      this.padDisplays[9],
      this._controllerMap.noteOn.Pad2
    );
    this.updateControllerLabel(
      this.padDisplays[10],
      this._controllerMap.noteOn.Pad3
    );
    this.updateControllerLabel(
      this.padDisplays[11],
      this._controllerMap.noteOn.Pad4
    );
    this.updateControllerLabel(
      this.padDisplays[12],
      this._controllerMap.noteOn.Pad5
    );
    this.updateControllerLabel(
      this.padDisplays[13],
      this._controllerMap.noteOn.Pad6
    );
    this.updateControllerLabel(
      this.padDisplays[14],
      this._controllerMap.noteOn.Pad7
    );
    this.updateControllerLabel(
      this.padDisplays[15],
      this._controllerMap.noteOn.Pad8
    );
    this.updateControllerLabel(
      this.padDisplays[0],
      this._controllerMap.noteOn.Pad9
    );
    this.updateControllerLabel(
      this.padDisplays[1],
      this._controllerMap.noteOn.Pad10
    );
    this.updateControllerLabel(
      this.padDisplays[2],
      this._controllerMap.noteOn.Pad11
    );
    this.updateControllerLabel(
      this.padDisplays[3],
      this._controllerMap.noteOn.Pad12
    );
    this.updateControllerLabel(
      this.padDisplays[4],
      this._controllerMap.noteOn.Pad13
    );
    this.updateControllerLabel(
      this.padDisplays[5],
      this._controllerMap.noteOn.Pad14
    );
    this.updateControllerLabel(
      this.padDisplays[6],
      this._controllerMap.noteOn.Pad15
    );
    this.updateControllerLabel(
      this.padDisplays[7],
      this._controllerMap.noteOn.Pad16
    );
